...
exports.locals = {
	...
	"dialog": "_31xSCcDqt23gWWdiMBrVn9",
	"html": "Ee_ja0SI8dm5rEtcV1CUL",
	"tabs": "_3OEostfnO7p_I2ye4JVqsW",
	"tab": "nqIF4GZ3lnHg5eL-6DerC"
};
...
class App extends React.Component {
    constructor(props) {
        ...
        ['htmlChanged', 'showHTML', 'showResult', 'preventEnter', 'simulateDialogChanged'].map(fn => this[fn] = this[fn].bind(this));
    }
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'button',
                        { 'uxp-variant': 'action', 'uxp-selected': view === VIEWS.HTML ? "true" : "", className: styles.tab, onClick: this.showHTML },
                        'HTML'
                    ),
                    React.createElement(
                        'button',
                        { 'uxp-variant': 'action', 'uxp-selected': view === VIEWS.RESULT ? "true" : "", className: styles.tab, onClick: this.showResult },
                        'Results'
                    )
                )
            ),
...
__webpack_require__(/*! ./reactShim */ "./src/reactShim.js");
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const ReactDOM = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");

const App = __webpack_require__(/*! ./App */ "./src/App.jsx");
const PanelController = __webpack_require__(/*! ./PanelController */ "./src/PanelController.js");
...
function getDialog(selection) {
    if (dialog == null) {
        ...
        ReactDOM.render(React.createElement(App, { dialog: dialog, html: html, selection: selection, onChange: htmlChanged }), dialog);
    }
    return dialog;
}
