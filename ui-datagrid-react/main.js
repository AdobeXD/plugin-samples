...
let data = [{ name: "Product Release Video", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Web Banner Ads", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Publish to Twitter", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Home Page Website Design", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Product Release Video", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Web Banner Ads", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Publish to Twitter", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Home Page Website Design", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Product Release Video", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Web Banner Ads", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Publish to Twitter", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }, { name: "Home Page Website Design", version: "v1", stage: "Stage", start: "Jan 01, 2018", due: "Dec 31, 2018", details: "More detail is here" }];
...
function createRow(data, index = -1) {
    ...
    return React.createElement(
        "div",
        { key: index.toString(), className: "row" },
...
module.exports = class DataGrid extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                "div",
                { className: "body", style: { overflow: "scroll", flex: "0 0 200px", height: "200px" } },
                data.map(createRow)
            )
        );
    }
...
const DataGrid = __webpack_require__(/*! ./DataGrid.jsx */ "./src/DataGrid.jsx");
...
let MainForm = __webpack_require__(/*! ./MainForm.jsx */ "./src/MainForm.jsx");

let dialog;
function getDialog() {
    if (dialog == null) {
        dialog = document.createElement("dialog");
        ReactDOM.render(React.createElement(MainForm, { dialog: dialog }), dialog);
    }
    return dialog;
}
