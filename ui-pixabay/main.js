...
const Stack = __webpack_require__(/*! ./Stack.jsx */ "./src/Stack.jsx");
...
const Card = (_ref = {}) => {
    let {
        ...
        rest = _objectWithoutProperties(_ref, ["selected", "src", "width", "height", "children"]);
    ...
    return React.createElement(
        ...
        React.createElement(
            "div",
            { style: styles.cardHero, style: { width: width - 4 } },
            React.createElement("img", { style: Object.assign({}, styles.cardHeroImg, { height: 100 }), src: src })
        ),
        children
    );
};
...
class PixabayDemo extends React.Component {
    ...
    doSearch() {
        ...
        this.setState(state => ({
            ...
            fetchJSON(buildQuery({ search, apiKey })).then(j => j.hits).then(hits => {
                this.setState(state => ({
    ...
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: 'col', style: { overflow: "auto", height: 400 } },
                React.createElement(
                    'div',
                    { className: 'row' },
                    React.createElement(
...
const Stack = (_ref = {}) => {
    let {
        ...
        rest = _objectWithoutProperties(_ref, ['direction', 'grow', 'shrink', 'style', 'children']);
