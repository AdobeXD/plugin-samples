...
| ----------------------------------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | --------------- |
| e2e-adobe-stock                     | UI, Network I/O (Fetch)                             | Lets users use End-to-end Adobe Stock Photo Search                                                                     | 13.0.0          |
| e2e-colorize-text                   | UI, Scenegraph, ScenenodeList                       | Provides several text color utilities                                                                                  | 13.0.0          |
| e2e-customize-banner                     | UI, Scenegraph                           | Provides a simple UI that lets user create custom sized banners                                                                     | 13.0.0          |
...
| quick-start-react                   | Scenegraph                                      | Creates a rectangle object and inserts it into the artboard (using React)                                              | 13.0.0          |
