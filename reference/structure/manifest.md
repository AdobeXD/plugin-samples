...
`icons` | `Array<Object>` | Icon(s) displayed in the Plugin Manager listing. png, jpg/jpeg formats are supported. Max file size is 1MB. The icons will be displayed in the Plugin Manager listing. 
