...
`icons` | `array<object>` | Icons displayed in the Plugin Manager listing. <br> PNG, JPG/JPEG formats are supported and the max file size is 1MB. <br> All four sizes are required - `[48, 96, 144, 192]`. | Publish
