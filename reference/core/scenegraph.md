...
Typically, you access scenegraph nodes via the [`selection`](../selection.md) argument that is passed to your plugin command.
...
this, instead use [commands](../commands.md).