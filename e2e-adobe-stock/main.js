...
const PreferencesStore = __webpack_require__(/*! ./store/Preferences */ "./src/store/Preferences.js");
const StockSearch = __webpack_require__(/*! ./components/StockSearch */ "./src/components/StockSearch.jsx");
const Preferences = __webpack_require__(/*! ./components/Preferences */ "./src/components/Preferences.jsx");
...
class App extends React.Component {
    ...
    render() {
        ...
        return !prefs ? React.createElement(
            "div",
            { className: "error" },
            "Loading preferences..."
        ) : React.createElement(
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./Card.css */ "./node_modules/css-loader/index.js!./src/components/Card.css");
...
const Card = (_ref = {}) => {
    let {
        ...
        rest = _objectWithoutProperties(_ref, ["selected", "src", "width", "height", "children", "onInfoClick"]);
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./Grid.css */ "./node_modules/css-loader/index.js!./src/components/Grid.css");
...
const Card = __webpack_require__(/*! ./Card */ "./src/components/Card.jsx");
const styles = __webpack_require__(/*! ./Grid.css */ "./src/components/Grid.css");

const Grid = ({ results, selected, onInfoClick, onClick } = {}) => React.createElement(
    'div',
    { className: styles.results },
    results.map(({ title, thumbnail_url }, idx) => React.createElement(Card, {
        key: idx,
        width: 200,
        height: 150,
        title: title,
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./List.css */ "./node_modules/css-loader/index.js!./src/components/List.css");
...
/***/ "./src/components/MaxResultsField.jsx":
/*!********************************************!*\
  !*** ./src/components/MaxResultsField.jsx ***!
  \********************************************/
/*! no static exports found */
...
const MaxResultsField = ({ label, onChange, value, options = MAX_RESULTS } = {}) => React.createElement(
    'label',
    { className: 'row' },
    ...
    React.createElement(
        'select',
        { 'uxp-quiet': 'true', onChange: onChange, value: value },
        options.map(n => React.createElement(
            'option',
            { key: n, value: `${n}` },
            `${n}`
        ))
...
/***/ "./src/components/Preferences.css":
/*!****************************************!*\
  !*** ./src/components/Preferences.css ***!
  \****************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./Preferences.css */ "./node_modules/css-loader/index.js!./src/components/Preferences.css");
...
class Preferences extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                "form",
                { method: "dialog", onSubmit: this.ok, className: styles.form },
                React.createElement(
                    "h1",
                    null,
                    React.createElement(
                        ...
                        React.createElement("img", { className: styles.logo, src: "./assets/logo.png" })
                    )
                ),
                ...
                React.createElement(
                    "label",
                    { className: `row ${styles.apiKeyField}` },
                    React.createElement(
                        "span",
                        null,
                        "API Key"
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "button",
                        { "uxp-variant": "secondary", id: "close", onClick: this.cancel },
                        "Don't Change"
                    ),
                    React.createElement(
                        "button",
                        { "uxp-variant": "cta", id: "ok", type: "submit" },
                        "Save Settings"
                    )
                )
            )
...
/***/ "./src/components/SearchField.css":
/*!****************************************!*\
  !*** ./src/components/SearchField.css ***!
  \****************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./SearchField.css */ "./node_modules/css-loader/index.js!./src/components/SearchField.css");
...
/***/ "./src/components/StockSearch.css":
/*!****************************************!*\
  !*** ./src/components/StockSearch.css ***!
  \****************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./StockSearch.css */ "./node_modules/css-loader/index.js!./src/components/StockSearch.css");
...
const styles = __webpack_require__(/*! ./StockSearch.css */ "./src/components/StockSearch.css");
...
class StockSearch extends React.Component {
    ...
    async insertPhotos(e) {
        ...
        editDocument(async () => {
            ...
            const { Rectangle, ImageFill, GraphicNode, Artboard, Text } = __webpack_require__(/*! scenegraph */ "scenegraph");
    ...
    infoForImage(idx) {
        ...
        __webpack_require__(/*! uxp */ "uxp").shell.openExternal(url);
    }
    ...
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                status === STATUS.LOADED || status === STATUS.WORKING ? viewMode === VIEWS.GRID ? React.createElement(Grid, { results: results, selected: selected, onInfoClick: this.infoForImage, onClick: this.selectImage }) : React.createElement(List, { results: results, selected: selected, onInfoClick: this.infoForImage, onClick: this.selectImage }) : status === STATUS.LOADING ? React.createElement(
                    'div',
                    null,
                    React.createElement(
                        'p',
                ...
                ) : status === STATUS.ERROR ? React.createElement(
                    'div',
                    null,
                    React.createElement(
                        'p',
                    ...
                    !apikey ? React.createElement(
                        ...
                        React.createElement(
                            'p',
                            null,
                            'Enter an API Key. You can get one from the Adobe Console. If you already have one, you can enter a key now.'
                        ),
                        React.createElement(
                            'div',
                            { className: 'row' },
                            React.createElement(
                                'button',
                                { 'uxp-variant': 'cta', onClick: onShowPreferences },
                                'Enter API Key'
                            )
                        )
                    ) : React.createElement(
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./ViewSwitcher.css */ "./node_modules/css-loader/index.js!./src/components/ViewSwitcher.css");
